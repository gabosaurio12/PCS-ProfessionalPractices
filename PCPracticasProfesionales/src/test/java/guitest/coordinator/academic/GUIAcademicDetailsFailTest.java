...
public class GUIAcademicDetailsFailTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIAcademicDetailsFailTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("GUIUpdateAcademicTestFail");
    ...
    void updateTestFail() {
        ...
        clickOn("#editButton");
        sleep(500);
        doubleClickOn("#personalNumberTextField").write("23888888");
        doubleClickOn("#emailTextField");
        doubleClickOn("#emailTextField").press(KeyCode.DELETE);

        verifyThat("#personalNumberTextField", hasText("23888888"));
