...
public class GUILinkedOrganizationDetailsFailTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUILinkedOrganizationDetailsFailTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("GUILinkedOrganizationDetailsTestFail");
    ...
    @Test
    public void updateOrganizationTestFail() {
        clickOn(String.valueOf(organizationID));
        clickOn("#editButton");
        sleep(250);
        doubleClickOn("#nameTextField");
        doubleClickOn("#nameTextField").push(KeyCode.DELETE);
        doubleClickOn("#emailTextField");
        doubleClickOn("#emailTextField").write("ecomoda@@gmail.com");

        verifyThat("#nameTextField", hasText(""));
        verifyThat("#emailTextField", hasText("ecomoda@@gmail.com"));
        clickOn("#saveButton");
        sleep(250);
        push(KeyCode.ENTER);
        sleep(250);
