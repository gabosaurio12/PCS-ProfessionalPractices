...
public class GUIProjectsDeleteTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIProjectsDeleteTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        controller.init();
        stage.setTitle("GUIProjectsDeleteTest");
