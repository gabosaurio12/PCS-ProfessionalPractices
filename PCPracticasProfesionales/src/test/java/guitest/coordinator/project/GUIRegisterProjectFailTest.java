...
public class GUIRegisterProjectFailTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIRegisterProjectFailTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        controller.init();
        stage.setTitle("GUIRegisterProjectTestFail");
    ...
    void registrationTestFail() {
        ...
        verifyThat("#statusTextField", hasText(""));
