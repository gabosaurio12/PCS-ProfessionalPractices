...
public class GUIAvailableProjectsFailTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIAvailableProjectsFailTest.class);
