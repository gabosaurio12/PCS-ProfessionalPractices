...
public class GUIStatisticsTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIStatisticsTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("GUIStatisticsTest");
