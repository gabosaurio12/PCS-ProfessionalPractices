...
public class GUIStatisticsFailTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIStatisticsFailTest.class);
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("GUIStatisticsTestFail");
