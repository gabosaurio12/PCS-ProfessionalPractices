...
public class GUIUploadReportTest extends ApplicationTest {
    private static final Logger logger = LogManager.getLogger(GUIUploadReportTest.class);
    ...
    void uploadReportTest() {
        ...
        write("80");
        clickOn("#filePathTextField").write(
                "/Users/gabosaurio/Downloads/" +
                        "para diseno de sw/expediente PP/" +
                        "Payon Aguilar/reportes/ReporteMayo_PayonAguilar.pdf");
